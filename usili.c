...
/**
 * start_vars - Initializes global variables for the Monty interpreter.
 * @var: Pointer to the global variables structure.
...
/**
 * create_instru - Creates and initializes an array
 * of instruction_t structures.
 *
 * Return: Pointer to the allocated array on success, NULL on failure.
 */
...
/**
 * call_funct - Calls the appropriate function based on the opcode.
 * @var: Pointer to the global variables structure.
 ...
 * Return: 0 if the string contains only digits, 1 otherwise.
 */
...
/**
 * free_all - Frees allocated memory and resources.
 */
